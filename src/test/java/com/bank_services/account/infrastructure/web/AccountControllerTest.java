...
class AccountControllerTest {
    ...
    // Mockeamos el cliente interno para /summary
    @MockBean
    ...
    void create_shouldReturn201AndBody_whenOk() throws Exception {
        ...
        // Dominio devuelto por el servicio
    ...
    void create_shouldReturn409_whenDuplicateCbu() throws Exception {
        ...
        mockMvc.perform(post("/api/v1/accounts")
                ...
                .andExpect(jsonPath("$.message", containsString("CBU")));
    }
    ...
    void getById_shouldReturn404_whenNotFound() throws Exception {
        UUID id = UUID.randomUUID();
        Mockito.when(accountService.getById(id))
    ...
    void delete_shouldReturn204_whenOk() throws Exception {
        ...
        // no hace falta stub del servicio si el método es void
    ...
    void summary_shouldReturn200_whenOk() throws Exception {
        ...
        Mockito.when(selfAccountClient.getAccountSummary(eq(id)))
                .thenReturn(summary);
